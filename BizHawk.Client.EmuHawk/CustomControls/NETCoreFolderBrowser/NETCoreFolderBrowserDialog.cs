...
//	[SRDescription(nameof(SR.DescriptionFolderBrowserDialog))]
	public sealed class NETCoreFolderBrowserDialog : CommonDialog
	{
		...
		/// <summary>
		///  Initializes a new instance of the <see cref='NETCoreFolderBrowserDialog'/> class.
		/// </summary>
		public NETCoreFolderBrowserDialog()
		{
			Reset();
		}
